...
public class Account {
	...
	public static Consumer<Account> add100 = i -> i.balance += 100;
	...
	*/
	public static Predicate<Account> lowerBound = i -> i.balance > 0;
	public static Predicate<Account> upperBound = i -> i.balance < 10000;
	...
	// TODO
	public static AddMaker maker = N -> account -> account.balance = account.balance + N;
