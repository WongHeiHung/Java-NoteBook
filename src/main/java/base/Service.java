...
public class Service implements EventEmitter {
    ...
    public void startTick(Duration interval) {
        ...
        //Event initialEvent = new Event(currentTime);
        ...
        TimerTask timerTask = new TimerTask() {
            ...
            public void run() {
                Date currentTime = new Date();
                Event periodicEvent = new Event(currentTime);
                emitEvent(periodicEvent);
            }
        };
        timer.schedule(timerTask, currentTime, interval.toMillis());
    }
