...
public class JUnitTest {
	...
	public void testUnknownFunction() {
		NoteBook nb = new NoteBook();
		nb.createTextNote("Note5", "Java", "comp3021");

		Character actual = ((TextNote)nb.getFolders().get(0).getNotes().get(0)).unknownFunction();
		Character expectedOutputs = 'a';
		assertEquals(expectedOutputs, actual, "The search results is not match");
	}
}
